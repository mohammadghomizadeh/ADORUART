            ...
            <section className={"w-3/5 border border-gray-300 rounded text-title"}>
                <section className={"flex flex-col gap-12 px-14 py-10"}>
                    ...
                    <div className={"flex flex-col"}>
                        ...
                        <input className={"w-490px border border-gray-300 py-3 px-4 rounded placeholder-gray-300"} type="text" placeholder={"City"}/>
                    </div>
                    <div className={"flex flex-col"}>
                    ...
                    <div className={"flex flex-col"}>
                        ...
                        <select className={"w-490px border border-gray-300 py-3 px-4 rounded"} >
                            <option value="" className={"text-gray-300"}>COUNTRY</option>
                        </select>
                    </div>
                    <div className={"flex flex-col"}>
                        <label  className={"text-gray-400"}>COMMENTS</label>
                        <textarea className={"w-490px border border-gray-300 py-3 px-4 rounded placeholder-gray-300"} placeholder={"Additional information to ensure safe delivery"}>
