...
function Events()  {
    ...
    return (
        <HomeLayout title={"Home"}>
            ...
            <section className={"flex gap-5 justify-between px-20 w-full my-20"}>
                <div className={"w-3/6"}>
                    ...
                    <div className={"mt-4"}>
                        ...
                        From Murch 16 to April 18
                        </span>
                    </div>
                    <div className={"flex gap-4 mt-14"}>
                        <button className={"bg-secondary text-white rounded w-30% py-4"}>
                            EXPLOR
                        </button>
                        <button className={"text-secondary border  border-secondary rounded w-70% py-4"}>
            ...
            <section className={"flex gap-5 justify-between px-20 w-full my-24"}>
                <div className={"w-3/6"}>
                    <img src="/images/events.png" className={"w-full border border-4 border-primary  rounded p-2"} alt=""/>
                </div>
                <div className={"w-3/6"}>
                    ...
                    <div className={"flex gap-2 text-gold items-center mt-6"}>
                        <span>
                            No auctions are scheduled at this time. Subscribe to be updated about the next one!
                        </span>
                    </div>
                    <div className={"mt-6"}>
                        <span className={"text-nft  border-b border-secondary"}>
                            EXPLORE ALL OF THE AUCTIONS
                        </span>
                    </div>
                    <div className={"flex gap-4 mt-40"}>
                        <button className={"bg-secondary text-white rounded w-30% py-4 "} disabled={true}>
                            EXPLOR
                        </button>
                        <button className={"text-secondary border  border-secondary rounded w-70% py-4"}>
                            Stay up to date on all of our events
            ...
            <section className={"flex gap-5 justify-between px-20 w-full my-24"}>
                <div className={"w-3/6"}>
                    ...
                    <div className={"mt-10"}>
                        <span className={"text-secondary text-xl font-bold"}>
                            The Female Figure: Silhouettes and Shadows
                        </span>
                    </div>
                    <div className={"mt-4"}>
                        <span className={"text-nft"}>
