...
import {LOGINUSER,USERINFO} from "../../hooks/useApi";
...
useEffect(()=>{
    if(!localStorage.getItem("__to_ken")){
        ...
        USERINFO(localStorage.getItem("__to_ken")).then((res:any)=>{
            setAccount(res.data);
        })
    }
},[])
    return (
        <HomeLayout title={"Profile"}>
            ...
            <div className="flex  items-center justify-center px-20 mt-4 w-full ">
                <span className=" mx-4 text-black text-2xl font-bold block">Hello {account.name}</span>
            </div>
            ...
            <div className="flex gap-6  items-center justify-center px-20 mt-10 w-full ">
                <a href="/profile" className="py-2 mx-4 text-gold text-lg  block cursor-pointer">My Profile</a>
                <a href="/profile/artwork" className="py-2 mx-4 text-gray-400 text-lg  block cursor-pointer">My Favorite Artwork</a>
                <a href="/profile/artists" className="py-2 mx-4 text-gray-400 text-lg  block cursor-pointer">My Favorite Artists</a>
            ...
            <section className={"text-black  bg-editbg flex flex-col items-center justify-center gap-10 py-10"}>
                ...
                <div className="flex  items-center justify-center px-20 mt-4 w-full ">
                    <span className=" mx-4 text-black text-2xl font-bold block">My Account</span>
                </div>
