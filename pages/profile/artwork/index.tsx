...
useEffect(()=>{
    ...
    return (
        <HomeLayout title={"Profile Artwork"}>
            ...
            <div className="flex gap-6  items-center justify-center px-20 mt-10 w-full ">
                ...
                <a href="/profile/artwork" className="py-2 mx-4 text-gold text-lg  block cursor-pointer">My Favorite Artwork</a>
            ...
            <section className={"text-black  bg-editbg flex flex-col items-center justify-center gap-10 py-10"}>
                ...
                <div className="flex  items-center justify-center px-20 mt-4 w-full ">
                    <span className=" mx-4 text-black text-2xl font-bold block">My Favorite Artwork</span>
                </div>
