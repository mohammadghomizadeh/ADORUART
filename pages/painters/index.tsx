...
function Painters()  {
    ...
    return (
        <HomeLayout title={"Home"}>
            ...
            <section className={"px-20 text-black flex gap-4 my-10"}>
                <div className={"w-full"}>
                    <select className={"border border-filter rounded p-4 w-full"}>
                ...
                <div className={"w-full"}>
                    <div>
                        <input type="text" placeholder={"Search by name..."} className={"p-4 w-full border border-filter rounded bg-search"}/>
                    </div>
                </div>
            </section>
