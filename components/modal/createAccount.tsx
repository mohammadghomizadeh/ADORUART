...
export const ModalCreateAccount = (props: Props) => {
    const {toggle,close,loginModalOpen} = props;
   ...
   const CreateAccount =  (e:any) =>{
       ...
       //         // "Authorization":  typeof window !== 'undefined' && localStorage.getItem("__TOKEN__")
       //     },
       //     // @ts-ignore
       //     body:JSON.stringify(IAccountData)
       // }).then((res) => res.json())
       //     .then((data) => {
       //         if(data){
       //             console.log(data)
                                        ...
                                        <section className={" bg-bodyLogin"}>
                                            ...
                                            <div className={"flex flex-col gap-y-5 text-left px-10 mt-4"}>
                                                <div>
                                                        ...
                                                        <input value={email} onChange={(e:any)=> setEmail(e.target.value)} type="email" placeholder={"Your Email"} className={"mt-1 placeholder-input text-black text-sm w-full py-2 rounded px-2"}/>
                                                </div>
                                                <div>
                                                        <span className={"text-title flex flex-col text-sm"}>
                                                        YOUR PASSWORD
                                                        </span>
                                                    <input value={password} onChange={(e:any)=> setPassword(e.target.value)} type="password" placeholder={"Your Password"} className={"mt-1 placeholder-input text-black text-sm w-full py-2 rounded px-2"}/>
                                                </div>
                                                <div>
                                                        <span className={"text-title flex flex-col text-sm"}>
                                                        YOUR Confirm PASSWORD
                                                        </span>
                                                    <input value={confirm} onChange={(e:any)=> setConfirm(e.target.value)} type="password" placeholder={"Your Confirm Password"} className={"mt-1 placeholder-input text-black text-sm w-full py-2 rounded px-2"}/>
                                                </div>
                                            </div>
                                                ...
                                                <div className="flex items-center">
                                                    <input id="link-checkbox" type="checkbox" value=""
                                                        ...
                                                        <label htmlFor="link-checkbox"
                                                            ...
                                                            By registering, I accept the General terms and conditions.
                                                        </label>
                                                </div>
                                            </div>
                                            <div className={"px-32 my-4"}>
                                                <button onClick={(e:any)=>CreateAccount(e)} className={"bg-secondary text-lg py-4 w-full rounded-sm   text-white"}>
                                                    CREATE AN ACCOUNT
                                                </button>
                                            </div>
                                            <div>
                                            ...
                                            <div className={"my-6"}>
                                                <span onClick={loginModalOpen} className={" font-bold border-b underline text-title cursor-pointer"}>
                                                    SIGN IN
                                                </span>
                                            </div>
                                        </section>
